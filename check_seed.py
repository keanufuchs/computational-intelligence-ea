...
# Verify Question 2 behavior
n = 6
# order_crossover logic
start, end = sorted(np.random.choice(n, 2, replace=False))
print(f"Seed {GLOBAL_SEED}: start={start}, end={end}")
